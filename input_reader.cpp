...
//    auto compare = [](const domain::Request& lh, const domain::Request& rh){
...
//}
////----------------------------------------------------------------------------
//Stop InputReader::ParseRequestsStops(const std::string& line)
//{
...
//}
////----------------------------------------------------------------------------
//std::tuple<domain::Bus, std::vector<string> > InputReader::ParseRequestsBuses(const std::string& line)
//{
...
////----------------------------------------------------------------------------
//std::vector<domain::Request> detail::ParseRequestOnType(std::istream &input){
//    std::string count;
//    getline(input, count);

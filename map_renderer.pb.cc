...
const uint32_t TableStruct_map_5frenderer_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::r_s_srlz::RenderSettings, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::r_s_srlz::RenderSettings, _impl_.width_),
  PROTOBUF_FIELD_OFFSET(::r_s_srlz::RenderSettings, _impl_.height_),
  PROTOBUF_FIELD_OFFSET(::r_s_srlz::RenderSettings, _impl_.padding_),
  PROTOBUF_FIELD_OFFSET(::r_s_srlz::RenderSettings, _impl_.line_width_),
  PROTOBUF_FIELD_OFFSET(::r_s_srlz::RenderSettings, _impl_.stop_radius_),
  PROTOBUF_FIELD_OFFSET(::r_s_srlz::RenderSettings, _impl_.bus_label_font_size_),
  PROTOBUF_FIELD_OFFSET(::r_s_srlz::RenderSettings, _impl_.bus_label_offset_),
  PROTOBUF_FIELD_OFFSET(::r_s_srlz::RenderSettings, _impl_.stop_label_font_size_),
  PROTOBUF_FIELD_OFFSET(::r_s_srlz::RenderSettings, _impl_.stop_label_offset_),
  PROTOBUF_FIELD_OFFSET(::r_s_srlz::RenderSettings, _impl_.underlayer_color_),
  PROTOBUF_FIELD_OFFSET(::r_s_srlz::RenderSettings, _impl_.underlayer_width_),
  PROTOBUF_FIELD_OFFSET(::r_s_srlz::RenderSettings, _impl_.color_palette_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::r_s_srlz::RenderSettings)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::r_s_srlz::_RenderSettings_default_instance_._instance,
};

const char descriptor_table_protodef_map_5frenderer_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\022map_renderer.proto\022\010r_s_srlz\032\tsvg.prot"
  ...
  " \001(\0132\017.r_s_srlz.Point\022\034\n\024stop_label_font"
  "_size\030\010 \001(\005\022*\n\021stop_label_offset\030\t \001(\0132\017"
  ".r_s_srlz.Point\022)\n\020underlayer_color\030\n \001("
  "\0132\017.r_s_srlz.Color\022\030\n\020underlayer_width\030\013"
  " \001(\001\022&\n\rcolor_palette\030\014 \003(\0132\017.r_s_srlz.C"
  "olorb\006proto3"
  ;
...
class RenderSettings::_Internal {
 public:
  static const ::r_s_srlz::Point& bus_label_offset(const RenderSettings* msg);
  static const ::r_s_srlz::Point& stop_label_offset(const RenderSettings* msg);
  static const ::r_s_srlz::Color& underlayer_color(const RenderSettings* msg);
};

const ::r_s_srlz::Point&
...
RenderSettings::RenderSettings(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:r_s_srlz.RenderSettings)
}
RenderSettings::RenderSettings(const RenderSettings& from)
  ...
  if (from._internal_has_bus_label_offset()) {
    _this->_impl_.bus_label_offset_ = new ::r_s_srlz::Point(*from._impl_.bus_label_offset_);
  }
  if (from._internal_has_stop_label_offset()) {
    _this->_impl_.stop_label_offset_ = new ::r_s_srlz::Point(*from._impl_.stop_label_offset_);
  }
  if (from._internal_has_underlayer_color()) {
    _this->_impl_.underlayer_color_ = new ::r_s_srlz::Color(*from._impl_.underlayer_color_);
  }
  ...
  // @@protoc_insertion_point(copy_constructor:r_s_srlz.RenderSettings)
}
...
RenderSettings::~RenderSettings() {
  // @@protoc_insertion_point(destructor:r_s_srlz.RenderSettings)
...
// @@protoc_insertion_point(message_clear_start:r_s_srlz.RenderSettings)
...
uint8_t* RenderSettings::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:r_s_srlz.RenderSettings)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:r_s_srlz.RenderSettings)
  return target;
}

size_t RenderSettings::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:r_s_srlz.RenderSettings)
  size_t total_size = 0;
...
void RenderSettings::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:r_s_srlz.RenderSettings)
  ...
  if (from._internal_has_bus_label_offset()) {
    _this->_internal_mutable_bus_label_offset()->::r_s_srlz::Point::MergeFrom(
        from._internal_bus_label_offset());
  }
  if (from._internal_has_stop_label_offset()) {
    _this->_internal_mutable_stop_label_offset()->::r_s_srlz::Point::MergeFrom(
        from._internal_stop_label_offset());
  }
  if (from._internal_has_underlayer_color()) {
    _this->_internal_mutable_underlayer_color()->::r_s_srlz::Color::MergeFrom(
...
// @@protoc_insertion_point(class_specific_copy_from_start:r_s_srlz.RenderSettings)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::r_s_srlz::RenderSettings*
Arena::CreateMaybeMessage< ::r_s_srlz::RenderSettings >(Arena* arena) {
  return Arena::CreateMessageInternal< ::r_s_srlz::RenderSettings >(arena);
}

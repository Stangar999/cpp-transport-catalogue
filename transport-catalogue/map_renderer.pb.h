...
PROTOBUF_NAMESPACE_OPEN
template<> ::r_s_srlz::RenderSettings* Arena::CreateMaybeMessage<::r_s_srlz::RenderSettings>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace r_s_srlz {
...
class RenderSettings final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:r_s_srlz.RenderSettings) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "r_s_srlz.RenderSettings";
  }
  protected:
  ...
  // repeated .r_s_srlz.Color color_palette = 12;
  int color_palette_size() const;
  private:
  int _internal_color_palette_size() const;
  public:
  void clear_color_palette();
  ::r_s_srlz::Color* mutable_color_palette(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::r_s_srlz::Color >*
      mutable_color_palette();
  private:
  const ::r_s_srlz::Color& _internal_color_palette(int index) const;
  ::r_s_srlz::Color* _internal_add_color_palette();
  public:
  const ::r_s_srlz::Color& color_palette(int index) const;
  ::r_s_srlz::Color* add_color_palette();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::r_s_srlz::Color >&
      color_palette() const;

  // .r_s_srlz.Point bus_label_offset = 7;
  bool has_bus_label_offset() const;
  private:
  bool _internal_has_bus_label_offset() const;
  public:
  void clear_bus_label_offset();
  const ::r_s_srlz::Point& bus_label_offset() const;
  PROTOBUF_NODISCARD ::r_s_srlz::Point* release_bus_label_offset();
  ::r_s_srlz::Point* mutable_bus_label_offset();
  void set_allocated_bus_label_offset(::r_s_srlz::Point* bus_label_offset);
  private:
  const ::r_s_srlz::Point& _internal_bus_label_offset() const;
  ::r_s_srlz::Point* _internal_mutable_bus_label_offset();
  public:
  void unsafe_arena_set_allocated_bus_label_offset(
      ::r_s_srlz::Point* bus_label_offset);
  ::r_s_srlz::Point* unsafe_arena_release_bus_label_offset();

  // .r_s_srlz.Point stop_label_offset = 9;
  bool has_stop_label_offset() const;
  private:
  bool _internal_has_stop_label_offset() const;
  public:
  void clear_stop_label_offset();
  const ::r_s_srlz::Point& stop_label_offset() const;
  PROTOBUF_NODISCARD ::r_s_srlz::Point* release_stop_label_offset();
  ::r_s_srlz::Point* mutable_stop_label_offset();
  void set_allocated_stop_label_offset(::r_s_srlz::Point* stop_label_offset);
  private:
  const ::r_s_srlz::Point& _internal_stop_label_offset() const;
  ::r_s_srlz::Point* _internal_mutable_stop_label_offset();
  public:
  void unsafe_arena_set_allocated_stop_label_offset(
      ::r_s_srlz::Point* stop_label_offset);
  ::r_s_srlz::Point* unsafe_arena_release_stop_label_offset();

  // .r_s_srlz.Color underlayer_color = 10;
  bool has_underlayer_color() const;
  private:
  bool _internal_has_underlayer_color() const;
  public:
  void clear_underlayer_color();
  const ::r_s_srlz::Color& underlayer_color() const;
  PROTOBUF_NODISCARD ::r_s_srlz::Color* release_underlayer_color();
  ::r_s_srlz::Color* mutable_underlayer_color();
  void set_allocated_underlayer_color(::r_s_srlz::Color* underlayer_color);
  private:
  const ::r_s_srlz::Color& _internal_underlayer_color() const;
  ::r_s_srlz::Color* _internal_mutable_underlayer_color();
  public:
  void unsafe_arena_set_allocated_underlayer_color(
      ::r_s_srlz::Color* underlayer_color);
  ::r_s_srlz::Color* unsafe_arena_release_underlayer_color();
  ...
  // @@protoc_insertion_point(class_scope:r_s_srlz.RenderSettings)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::r_s_srlz::Color > color_palette_;
    ::r_s_srlz::Point* bus_label_offset_;
    ::r_s_srlz::Point* stop_label_offset_;
    ::r_s_srlz::Color* underlayer_color_;
    double width_;
    double height_;
    double padding_;
    double line_width_;
...
inline double RenderSettings::width() const {
  // @@protoc_insertion_point(field_get:r_s_srlz.RenderSettings.width)
...
inline void RenderSettings::set_width(double value) {
  ...
  // @@protoc_insertion_point(field_set:r_s_srlz.RenderSettings.width)
}
...
inline double RenderSettings::height() const {
  // @@protoc_insertion_point(field_get:r_s_srlz.RenderSettings.height)
...
inline void RenderSettings::set_height(double value) {
  ...
  // @@protoc_insertion_point(field_set:r_s_srlz.RenderSettings.height)
}
...
inline double RenderSettings::padding() const {
  // @@protoc_insertion_point(field_get:r_s_srlz.RenderSettings.padding)
...
inline void RenderSettings::set_padding(double value) {
  ...
  // @@protoc_insertion_point(field_set:r_s_srlz.RenderSettings.padding)
}
...
inline double RenderSettings::line_width() const {
  // @@protoc_insertion_point(field_get:r_s_srlz.RenderSettings.line_width)
...
inline void RenderSettings::set_line_width(double value) {
  ...
  // @@protoc_insertion_point(field_set:r_s_srlz.RenderSettings.line_width)
}
...
inline double RenderSettings::stop_radius() const {
  // @@protoc_insertion_point(field_get:r_s_srlz.RenderSettings.stop_radius)
...
inline void RenderSettings::set_stop_radius(double value) {
  ...
  // @@protoc_insertion_point(field_set:r_s_srlz.RenderSettings.stop_radius)
}
...
inline int32_t RenderSettings::bus_label_font_size() const {
  // @@protoc_insertion_point(field_get:r_s_srlz.RenderSettings.bus_label_font_size)
...
inline void RenderSettings::set_bus_label_font_size(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:r_s_srlz.RenderSettings.bus_label_font_size)
}
...
inline const ::r_s_srlz::Point& RenderSettings::_internal_bus_label_offset() const {
  const ::r_s_srlz::Point* p = _impl_.bus_label_offset_;
  return p != nullptr ? *p : reinterpret_cast<const ::r_s_srlz::Point&>(
      ::r_s_srlz::_Point_default_instance_);
}
inline const ::r_s_srlz::Point& RenderSettings::bus_label_offset() const {
  // @@protoc_insertion_point(field_get:r_s_srlz.RenderSettings.bus_label_offset)
...
inline void RenderSettings::unsafe_arena_set_allocated_bus_label_offset(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:r_s_srlz.RenderSettings.bus_label_offset)
}
inline ::r_s_srlz::Point* RenderSettings::release_bus_label_offset() {
  
  ::r_s_srlz::Point* temp = _impl_.bus_label_offset_;
...
inline ::r_s_srlz::Point* RenderSettings::unsafe_arena_release_bus_label_offset() {
  // @@protoc_insertion_point(field_release:r_s_srlz.RenderSettings.bus_label_offset)
  
  ::r_s_srlz::Point* temp = _impl_.bus_label_offset_;
  _impl_.bus_label_offset_ = nullptr;
  return temp;
}
inline ::r_s_srlz::Point* RenderSettings::_internal_mutable_bus_label_offset() {
  
  if (_impl_.bus_label_offset_ == nullptr) {
    auto* p = CreateMaybeMessage<::r_s_srlz::Point>(GetArenaForAllocation());
    _impl_.bus_label_offset_ = p;
  }
  return _impl_.bus_label_offset_;
}
inline ::r_s_srlz::Point* RenderSettings::mutable_bus_label_offset() {
  ::r_s_srlz::Point* _msg = _internal_mutable_bus_label_offset();
  // @@protoc_insertion_point(field_mutable:r_s_srlz.RenderSettings.bus_label_offset)
  return _msg;
}
inline void RenderSettings::set_allocated_bus_label_offset(::r_s_srlz::Point* bus_label_offset) {
  ...
  _impl_.bus_label_offset_ = bus_label_offset;
  // @@protoc_insertion_point(field_set_allocated:r_s_srlz.RenderSettings.bus_label_offset)
}
...
inline int32_t RenderSettings::stop_label_font_size() const {
  // @@protoc_insertion_point(field_get:r_s_srlz.RenderSettings.stop_label_font_size)
...
inline void RenderSettings::set_stop_label_font_size(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:r_s_srlz.RenderSettings.stop_label_font_size)
}
...
inline const ::r_s_srlz::Point& RenderSettings::_internal_stop_label_offset() const {
  const ::r_s_srlz::Point* p = _impl_.stop_label_offset_;
  return p != nullptr ? *p : reinterpret_cast<const ::r_s_srlz::Point&>(
      ::r_s_srlz::_Point_default_instance_);
}
inline const ::r_s_srlz::Point& RenderSettings::stop_label_offset() const {
  // @@protoc_insertion_point(field_get:r_s_srlz.RenderSettings.stop_label_offset)
...
inline void RenderSettings::unsafe_arena_set_allocated_stop_label_offset(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:r_s_srlz.RenderSettings.stop_label_offset)
}
inline ::r_s_srlz::Point* RenderSettings::release_stop_label_offset() {
  
  ::r_s_srlz::Point* temp = _impl_.stop_label_offset_;
...
inline ::r_s_srlz::Point* RenderSettings::unsafe_arena_release_stop_label_offset() {
  // @@protoc_insertion_point(field_release:r_s_srlz.RenderSettings.stop_label_offset)
  
  ::r_s_srlz::Point* temp = _impl_.stop_label_offset_;
  _impl_.stop_label_offset_ = nullptr;
  return temp;
}
inline ::r_s_srlz::Point* RenderSettings::_internal_mutable_stop_label_offset() {
...
inline ::r_s_srlz::Point* RenderSettings::mutable_stop_label_offset() {
  ::r_s_srlz::Point* _msg = _internal_mutable_stop_label_offset();
  // @@protoc_insertion_point(field_mutable:r_s_srlz.RenderSettings.stop_label_offset)
  return _msg;
}
inline void RenderSettings::set_allocated_stop_label_offset(::r_s_srlz::Point* stop_label_offset) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.stop_label_offset_);
  }
  ...
  _impl_.stop_label_offset_ = stop_label_offset;
  // @@protoc_insertion_point(field_set_allocated:r_s_srlz.RenderSettings.stop_label_offset)
}
...
inline const ::r_s_srlz::Color& RenderSettings::_internal_underlayer_color() const {
  const ::r_s_srlz::Color* p = _impl_.underlayer_color_;
  return p != nullptr ? *p : reinterpret_cast<const ::r_s_srlz::Color&>(
      ::r_s_srlz::_Color_default_instance_);
}
inline const ::r_s_srlz::Color& RenderSettings::underlayer_color() const {
  // @@protoc_insertion_point(field_get:r_s_srlz.RenderSettings.underlayer_color)
...
inline void RenderSettings::unsafe_arena_set_allocated_underlayer_color(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:r_s_srlz.RenderSettings.underlayer_color)
}
inline ::r_s_srlz::Color* RenderSettings::release_underlayer_color() {
  
  ::r_s_srlz::Color* temp = _impl_.underlayer_color_;
...
inline ::r_s_srlz::Color* RenderSettings::unsafe_arena_release_underlayer_color() {
  // @@protoc_insertion_point(field_release:r_s_srlz.RenderSettings.underlayer_color)
  
  ::r_s_srlz::Color* temp = _impl_.underlayer_color_;
  _impl_.underlayer_color_ = nullptr;
  return temp;
}
inline ::r_s_srlz::Color* RenderSettings::_internal_mutable_underlayer_color() {
  
  if (_impl_.underlayer_color_ == nullptr) {
    auto* p = CreateMaybeMessage<::r_s_srlz::Color>(GetArenaForAllocation());
    _impl_.underlayer_color_ = p;
  }
  return _impl_.underlayer_color_;
}
inline ::r_s_srlz::Color* RenderSettings::mutable_underlayer_color() {
  ::r_s_srlz::Color* _msg = _internal_mutable_underlayer_color();
  // @@protoc_insertion_point(field_mutable:r_s_srlz.RenderSettings.underlayer_color)
  return _msg;
}
inline void RenderSettings::set_allocated_underlayer_color(::r_s_srlz::Color* underlayer_color) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.underlayer_color_);
  }
  ...
  _impl_.underlayer_color_ = underlayer_color;
  // @@protoc_insertion_point(field_set_allocated:r_s_srlz.RenderSettings.underlayer_color)
}
...
inline double RenderSettings::underlayer_width() const {
  // @@protoc_insertion_point(field_get:r_s_srlz.RenderSettings.underlayer_width)
...
inline void RenderSettings::set_underlayer_width(double value) {
  ...
  // @@protoc_insertion_point(field_set:r_s_srlz.RenderSettings.underlayer_width)
}
...
inline ::r_s_srlz::Color* RenderSettings::mutable_color_palette(int index) {
  // @@protoc_insertion_point(field_mutable:r_s_srlz.RenderSettings.color_palette)
  return _impl_.color_palette_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::r_s_srlz::Color >*
RenderSettings::mutable_color_palette() {
  // @@protoc_insertion_point(field_mutable_list:r_s_srlz.RenderSettings.color_palette)
  return &_impl_.color_palette_;
}
inline const ::r_s_srlz::Color& RenderSettings::_internal_color_palette(int index) const {
  return _impl_.color_palette_.Get(index);
}
inline const ::r_s_srlz::Color& RenderSettings::color_palette(int index) const {
  // @@protoc_insertion_point(field_get:r_s_srlz.RenderSettings.color_palette)
  return _internal_color_palette(index);
}
inline ::r_s_srlz::Color* RenderSettings::_internal_add_color_palette() {
  return _impl_.color_palette_.Add();
}
inline ::r_s_srlz::Color* RenderSettings::add_color_palette() {
  ::r_s_srlz::Color* _add = _internal_add_color_palette();
  // @@protoc_insertion_point(field_add:r_s_srlz.RenderSettings.color_palette)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::r_s_srlz::Color >&
RenderSettings::color_palette() const {
  // @@protoc_insertion_point(field_list:r_s_srlz.RenderSettings.color_palette)
  return _impl_.color_palette_;
}
